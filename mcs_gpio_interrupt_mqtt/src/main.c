...
#define INTERRUPT_TASK_NAME                   "Interrupt app"
#define INTERRUPT_TASK_STACKSIZE              (2*1024)
#define INTERRUPT_TASK_PRIO                   TASK_PRIORITY_NORMAL
...
int main(void)
{
  ...
  /* User initial the parameters for wifi initial process,  system will determin which wifi operation mode
    ...
    xTaskCreate(interrupt_entry,
        INTERRUPT_TASK_NAME,
        INTERRUPT_TASK_STACKSIZE/sizeof(portSTACK_TYPE),
        NULL,
        2,
        NULL);
